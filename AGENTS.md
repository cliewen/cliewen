...
2. **Light — meaning is touched but not changed** ([PDR-002](docs/decisions/PDR-002-light-change-tier.md)). No decision, no acceptance-criterion or capability meaning change, no semantic plan mutation, no methodology carrier touched. Typical: typos or documentation clarity on a protected surface, dependency bumps, pure refactors, and CI plumbing.
