...
Run this pre-merge checklist before opening or updating any PR. When the `clue` CLI exists, `clue validate` performs the mechanical half. Never fix a failure by weakening the check.
