...
Run a Cliewen change from classification and proposal through implementation, digest, verification, and human-controlled merge.
...
- Before classifying or starting any repository change, read [Change scope and tiers](references/change-scope-and-tiers.md).
...
- After classification selects a light or full Cliewen change, read [Change loop](references/change-loop.md).
