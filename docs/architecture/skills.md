...
- Skills mutate through the change loop like everything else: improving a skill is a change with a branch and PR, edits the canonical source fragments or templates, runs the generator, and records a decision when the improvement stems from one.
