...
| **CLI (`clue`)** | Deterministic judge | Tells everyone whether it was done right; also materializes the starting point (`clue init`, [ADR-018](../decisions/ADR-018-init-templates-embedded.md)), regenerates the index blocks (`clue scaffold`, [ADR-019](../decisions/ADR-019-init-regenerates-indexes.md)), and previews or applies safe release migrations (`clue migrate`, [ADR-039](../decisions/ADR-039-versioned-corpus-migrations.md)) |
