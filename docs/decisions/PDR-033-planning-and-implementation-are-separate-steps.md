...
type: decision
status: verified
links: [PDR-017, PDR-007, PDR-019, PDR-040, G-001, P-013, AN-018]
...
No carrier outside this record states the reporting and asking rules today. The pause itself, in PDR-017's narrower form, is stated by the `clue-delta` source template and its generated and scaffolded copies, and by `guide/change-loop.md`. All of them are owed this amendment, and [P-013](../plans/P-013-simplification.md) splits them by surface: the skill carriers belong to M-063, which owns the skill trim and names this rewrite among its edits, and the guide belongs to M-064, which carries the public guide and the rest of the carrier prose M-063 does not reach.
