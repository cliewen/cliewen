...
- [PDR-029 — Simplification is judged by two tests, chosen by surface](PDR-029-simplification-tests-by-surface.md) · `inferred` — PDR-013's *does the core need it?* passes almost everything on Cliewen's own methodology carriers, where the cost is repetition inside one reading path and rules compressed past checkability.
<!-- clue:index:end -->
