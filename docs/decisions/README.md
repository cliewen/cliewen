...
- [PDR-025 — Truthful brownfield migration precedes simplification](PDR-025-brownfield-migration-precedes-simplification.md) · `inferred` — P-011 becomes the brownfield-migration campaign and simplification moves to P-012, because an extraction that can look green while changing what the source proves is the higher-risk boundary.
