...
| M-077 | **ADR-031 through ADR-060 are compacted under the same audit and preservation rule.** | `done` | The 30 ADRs were compacted with enduring context, binding outcomes, material alternatives, and carriers preserved; supersession, migration, evidence, ledger, and read-cost decisions remain explicit; `clue validate` is green with no lost link or identity. |
| M-078 | **PDR-001 through PDR-022 are compacted under the same audit and preservation rule.** | `done` | The 22 PDRs were compacted with enduring context, binding outcomes, supersession and amendment edges, material alternatives, and live carriers preserved; the transient audit accounted for removed prose, and `clue validate` is green with no lost link or identity. |
| M-079 | **PDR-023 onward, together with every decision record earlier milestones created, are compact under the same audit and preservation rule.** The plan closes only after re-derived validation and review confirm the whole live decision corpus follows the new contract. | `done` | PDR-023 through PDR-043 were compacted with enduring context, binding outcomes, material alternatives where material, amendment and supersession edges, and live carrier references preserved; PDR-044 through PDR-050, ADR-061, and IDR-001 through IDR-008 were already in the compact contract and were reviewed in the batch. The transient audit accounted for removed narrative as retained core, moved carrier guidance, or discarded chronology; re-derived `clue validate` and whitespace checks are green with no lost link or identity, and the live decision corpus follows PDR-046's compact shape. |
