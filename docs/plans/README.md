...
- [P-013 — Cliewen is simplified against a stated criterion](P-013-simplification.md) · `active` — Deferred by every campaign that named it, now open with M-062…M-068 and the shipped skills as its primary object: classify every statement in the skills and routing hub, trace every rule-bearing statement to a corpus artifact, trim and reorder the rules so they hold together and bind before they instruct, score and settle the remaining surface and pattern C, determine AN-013's three open findings, bound the agentic review loop, and close on re-derived cost evidence.
<!-- clue:index:end -->
