...
- [P-013 — Cliewen is simplified against a stated criterion](P-013-simplification.md) · `active` — Deferred by every campaign that named it, now open with M-062…M-066 and the shipped skills as its primary object: register and justify every statement in the skills and routing hub, trim them so each surviving statement earns its place, score and settle the rest of the surface against PDR-029's core test, determine AN-013's three open findings, and close on re-derived cost evidence.
<!-- clue:index:end -->
