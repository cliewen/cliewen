...
| The contract must hold at the assessment's reported order of magnitude. | Closed at the declared fixture scope by M-061. | AC-128 holds the command surface at that size and AC-129 the ordered path under a pinned release, including source-work preservation and every deterministic failure class. The fixture is generated and disposable: this closes the gate for the contract, and still makes no claim about any production adopter's corpus, tests, or CI. |
