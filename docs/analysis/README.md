...
- [AN-016 — Heimdall extraction removed SVG architecture views to satisfy C-007](AN-016-heimdall-svg-extraction-loss.md) · `active` — The OpenSpec-to-Cliewen extraction recorded at Heimdall commit `b443613c` removed seven `!...` links from C4 and C5 architecture-view Markdown files and deleted their `images/` directories.
<!-- clue:index:end -->
