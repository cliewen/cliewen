...
- Use an inspection ladder for third-party programs: black-box behavior first, intentionally bundled source where its terms permit inspection, and decompilation only after the applicable permission or legal basis, purpose, and information boundary are established for that program and activity.
