...
- [G-007 — The changelog-scope rule names the surface that reaches an adopter](G-007-changelog-scope-names-the-shipped-surface.md) · `proposed` — **Who wants it:** repository contributors and agents deciding whether a change owes a release note (2026-08-11), found while CH-148 removed an entry it had written for a fix to this repository's own…
<!-- clue:index:end -->
