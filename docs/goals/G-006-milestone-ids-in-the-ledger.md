...
**Who wants it:** repository contributors and agents allocating a new milestone number (2026-08-10), found while closing [P-013](../plans/P-013-simplification.md) and opening [P-014](../plans/P-014-supersession-edge.md): `clue id next M` returns `M-001`, even though M-001 through M-069 already exist as milestone rows across `docs/plans/*.md`.
