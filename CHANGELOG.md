...
- **The public guide now separates required and optional tooling.** Its getting-started page distinguishes Git and `clue` from Go for source installation, the recommended GitHub CLI, and the Node.js tooling needed only to build the guide or contribute to Cliewen itself.
