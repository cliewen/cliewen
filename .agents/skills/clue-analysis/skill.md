...
7. Route any outcome that constitutes a decision under **Decision records** below. A rejected alternative that is itself a decision gets a rejected decision record, not only a paragraph in the findings.
