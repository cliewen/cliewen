...
2. **Propose**: create `/changes/CH-xxx-slug/` with
   ...
   - `open-questions.md` — blocking questions. When one appears, write it and **stop**; the human's answer becomes an ADR. Commit this before implementing: the branch is the proposal.
