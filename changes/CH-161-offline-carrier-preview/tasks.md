...
status: open
links: [CH-161]
title: Tasks for CH-161
---

# Tasks

- [x] Add AC-149 for previewing local carriers when release availability is unknown and for keeping the two conclusions separate.
- [x] Amend PDR-043 so an unavailable release list does not prevent the local preview and a clean preview does not prove published release freshness.
