...
status: open
links: [CH-044]
title: CH-044 task breakdown
---

# Tasks

- [x] Record the operative-requirement and lifecycle-exception boundary in the durable methodology
- [x] Add the finding-grounding rules to the canonical verification skill and regenerate distributed carriers
