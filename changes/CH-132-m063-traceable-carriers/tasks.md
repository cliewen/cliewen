...
- [ ] Add the user-facing CHANGELOG entry and digest P-013 / M-063 bookkeeping after the exit criterion is evidenced.
- [ ] Run applicable checks and the full `clue-verify` review loop on the committed candidate, then publish the ready PR with its acceptance brief.
