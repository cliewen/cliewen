...
- [ ] Write [ADR-049](../../docs/decisions/ADR-049-migration-parity-manifests.md): the source/target manifest schema and the five required failure classes
- [ ] Add AC-109..AC-114 to `docs/capabilities/CAP-003-extract/criteria.md`: clean parity pass, missing criterion, orphaned tag, changed direction/location, stale source fingerprint, unjustified `@draft`/`Human`/retirement disposition
